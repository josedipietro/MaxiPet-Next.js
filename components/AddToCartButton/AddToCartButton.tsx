...
export const AddToCartButton = ({ product }: { product: Product }) => {
  ...
  return (
    <button
      ...
      className="py-1 px-6 flex justify-center items-center rounded-lg bg-primary-300 text-font-white disabled:bg-neutral-600 hover:bg-primary-400 transition-all"
    >
